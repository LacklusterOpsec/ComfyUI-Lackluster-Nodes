...
all_attention_backends_module = _load_node_module("all_attention_backends")
...
ATTENTION_BACKENDS_NODE_CLASS_MAPPINGS = _get_module_mapping(all_attention_backends_module, "NODE_CLASS_MAPPINGS")
ATTENTION_BACKENDS_NODE_DISPLAY_NAME_MAPPINGS = _get_module_mapping(all_attention_backends_module, "NODE_DISPLAY_NAME_MAPPINGS")

NODE_CLASS_MAPPINGS = {
    **ALLTALK_NODE_CLASS_MAPPINGS,
    **FRAME_SELECTOR_NODE_CLASS_MAPPINGS,
    **TEXT_MULTILINE_NODE_CLASS_MAPPINGS,
    **UV_OUTDATED_NODE_CLASS_MAPPINGS,
    **TRAP_NODE_CLASS_MAPPINGS,
    **LACKLUSTER_PROMPT_ENHANCER_NODE_CLASS_MAPPINGS,
    **TRAP2_NODE_CLASS_MAPPINGS,
    **TRAP_STYLE_SELECTOR_NODE_CLASS_MAPPINGS,
    **QWEN_MULTIANGLE_NODE_CLASS_MAPPINGS,
    **CAM_ORBIT_NODE_CLASS_MAPPINGS,
    **SHOT_QUEUE_NODE_CLASS_MAPPINGS,
    **SHOT_QUEUE_V2_NODE_CLASS_MAPPINGS,
    **ATTENTION_BACKENDS_NODE_CLASS_MAPPINGS,
}
NODE_DISPLAY_NAME_MAPPINGS = {
    **ALLTALK_NODE_DISPLAY_NAMES,
    **FRAME_SELECTOR_NODE_DISPLAY_NAME_MAPPINGS,
    **TEXT_MULTILINE_NODE_DISPLAY_NAME_MAPPINGS,
    **UV_OUTDATED_NODE_DISPLAY_NAME_MAPPINGS,
    **TRAP_NODE_DISPLAY_NAME_MAPPINGS,
    **LACKLUSTER_PROMPT_ENHANCER_NODE_DISPLAY_NAME_MAPPINGS,
    **TRAP2_NODE_DISPLAY_NAME_MAPPINGS,
    **TRAP_STYLE_SELECTOR_NODE_DISPLAY_NAME_MAPPINGS,
    **QWEN_MULTIANGLE_NODE_DISPLAY_NAME_MAPPINGS,
    **CAM_ORBIT_NODE_DISPLAY_NAME_MAPPINGS,
    **SHOT_QUEUE_NODE_DISPLAY_NAME_MAPPINGS,
    **SHOT_QUEUE_V2_NODE_DISPLAY_NAME_MAPPINGS,
    **ATTENTION_BACKENDS_NODE_DISPLAY_NAME_MAPPINGS,
}
WEB_DIRECTORY = "./js"
